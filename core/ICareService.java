...
public interface ICareService extends OpenmrsService {
	...
	//METHODS FOR iCare SMS API
	String queuedResponse(String id, String status);
	
	String sentResponse(String id, String status);
	
	String errorResponse(String errorMessage);
	
	String processIncomingAction(String from, String message, String messageType);
	
	String processIncomingCall(String from, String message, String messageType);
}
